...
public sealed partial class DataGrid1Page : Page
{
    ...
    private void ADD_Click(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
    {
        ...
        if (donecheck)
        {
            ViewModel.Source.Add(new Core.Models.Order() { OrderId = count, OrderDate = DateTime.Now });
        }
        else
        {
            ViewModel.Source.Add(new Core.Models.Order() { OrderId = 0, OrderDate = DateTime.Now });
        }
    }
